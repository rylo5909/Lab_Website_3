...
app.get('/team_stats', function(req, res) {
  ...
  //var winner = 'IF ((SELECT home_score FROM football_games) < (SELECT visitor_score FROM football_games)) BEGIN SELECT visitor_name FROM football_games END';
    ...
    .then(info => {
      ...
      info[0].forEach(item => {
        item.winner = games.visitor_name
      });
      console.log(info[0]);
      console.log(info[1]);
      console.log(info[2]);
